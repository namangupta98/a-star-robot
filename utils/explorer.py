...
class Explorer:
    ...
    def take_action(self, parent_node, action):
        ...
        return (parent_node[0] + int(constants.scaling_factor * self.step_size * np.sin(np.pi * theta / 180)),
                parent_node[1] + int(constants.scaling_factor * self.step_size * np.cos(np.pi * theta / 180)),
